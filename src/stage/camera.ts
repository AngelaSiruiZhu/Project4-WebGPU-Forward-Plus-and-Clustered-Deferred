...
class CameraUniforms {
    readonly buffer = new ArrayBuffer(52 * 4); //viewProjMat + viewMat + projMat + nearFar + padding
    ...
    set nearFar(v: [number, number]) {
        const i = 48;
        this.floatView[i + 0] = v[0];
        this.floatView[i + 1] = v[1];
    }
}
